...
use crate::app::tests::{MockExistingTopicRepo, MockSetRepo, MockTopicRepo, TestEngine};
...
mod return_scenario {
    ...
    pub mod set {
        ...
        pub fn error<'a>(_: TopicId, _: String, _: Vec<Value>) -> SetMockReturn<Set> {
    ...
    pub mod get {
        ...
        pub fn found(
            ...
            set_id: SetId,
            name: impl ToString,
        ) -> impl FnOnce(TopicId, SetId) -> SetMockReturn<Set> {
        ...
        pub fn error<'a>(_: TopicId, _: SetId) -> SetMockReturn<Set> {
    ...
    pub mod delete {
        ...
        pub fn success<'a>(_: TopicId, _: SetId) -> SetMockReturn<ResourceOutcome> {
        ...
        pub fn error<'a>(_: TopicId, _: SetId) -> SetMockReturn<ResourceOutcome> {
